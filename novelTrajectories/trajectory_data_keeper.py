...
from cad120_data_reader import Trajectory_Data_Reader
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Trajectory QSR keeper in QSRlib format")
    ...
    if args.load is None:
        ...
        qsrlib = QSRlib()
        reader = Trajectory_Data_Reader(config_filename=reader_ini, load_from_files=reader_load)
        print()
        keeper = Trajectory_QSR_Keeper(description="description", reader=reader, qsrlib=qsrlib, which_qsr=which_qsr)
        # optional saving
